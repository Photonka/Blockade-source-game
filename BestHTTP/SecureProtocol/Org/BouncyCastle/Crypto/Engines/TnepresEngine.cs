...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Crypto.Engines
{
	...
	public sealed class TnepresEngine : SerpentEngineBase
	{
		...
		// (get) Token: 0x060035CE RID: 13774 RVA: 0x0014EE75 File Offset: 0x0014D075
		...
		// Token: 0x060035CF RID: 13775 RVA: 0x0014EE7C File Offset: 0x0014D07C
		protected override int[] MakeWorkingKey(byte[] key)
		{
			...
			{
				array[num++] = (int)Pack.BE_To_UInt32(key, i);
			}
			if (i == 0)
			{
				array[num++] = (int)Pack.BE_To_UInt32(key, 0);
				if (num < 8)
				{
					array[num] = 1;
				}
				...
				for (int j = 8; j < 16; j++)
				{
					array[j] = SerpentEngineBase.RotateLeft(array[j - 8] ^ array[j - 5] ^ array[j - 3] ^ array[j - 1] ^ -1640531527 ^ j - 8, 11);
				}
				Array.Copy(array, 8, array2, 0, 8);
				for (int k = 8; k < num2; k++)
				{
					array2[k] = SerpentEngineBase.RotateLeft(array2[k - 8] ^ array2[k - 5] ^ array2[k - 3] ^ array2[k - 1] ^ -1640531527 ^ k, 11);
				}
		...
		// Token: 0x060035D0 RID: 13776 RVA: 0x0014F888 File Offset: 0x0014DA88
		...
		// Token: 0x060035D1 RID: 13777 RVA: 0x001502B4 File Offset: 0x0014E4B4
