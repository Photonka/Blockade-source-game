...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.TeleTrust
{
	...
	{
		// Token: 0x0600403D RID: 16445 RVA: 0x00096BA2 File Offset: 0x00094DA2
		private static ECCurve ConfigureCurve(ECCurve curve)
		{
			return curve;
		}

		// Token: 0x0600403E RID: 16446 RVA: 0x001816F0 File Offset: 0x0017F8F0
		...
		// Token: 0x0600403F RID: 16447 RVA: 0x0018171C File Offset: 0x0017F91C
		...
		// Token: 0x06004040 RID: 16448 RVA: 0x00181860 File Offset: 0x0017FA60
		...
		// Token: 0x06004041 RID: 16449 RVA: 0x00181880 File Offset: 0x0017FA80
		...
		// Token: 0x06004042 RID: 16450 RVA: 0x001818A9 File Offset: 0x0017FAA9
		public static DerObjectIdentifier GetOid(string name)
		{
			return (DerObjectIdentifier)TeleTrusTNamedCurves.objIds[Platform.ToUpperInvariant(name)];
		}

		// Token: 0x06004043 RID: 16451 RVA: 0x001818C0 File Offset: 0x0017FAC0
		...
		// (get) Token: 0x06004044 RID: 16452 RVA: 0x001818D2 File Offset: 0x0017FAD2
		...
		// Token: 0x06004045 RID: 16453 RVA: 0x001818E3 File Offset: 0x0017FAE3
		...
		{
			// Token: 0x06004F5C RID: 20316 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP160r1Holder()
			{
			}

			// Token: 0x06004F5D RID: 20317 RVA: 0x001B8564 File Offset: 0x001B6764
		...
		{
			// Token: 0x06004F5F RID: 20319 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP160t1Holder()
			{
			}

			// Token: 0x06004F60 RID: 20320 RVA: 0x001B85E0 File Offset: 0x001B67E0
			protected override X9ECParameters CreateParameters()
			{
				BigInteger bigInteger = new BigInteger("E95E4A5F737059DC60DF5991D45029409E60FC09", 16);
				BigInteger bigInteger2 = new BigInteger("01", 16);
		...
		{
			// Token: 0x06004F62 RID: 20322 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP192r1Holder()
			{
			}

			// Token: 0x06004F63 RID: 20323 RVA: 0x001B865C File Offset: 0x001B685C
			protected override X9ECParameters CreateParameters()
			{
		...
		{
			// Token: 0x06004F65 RID: 20325 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP192t1Holder()
			{
			}

			// Token: 0x06004F66 RID: 20326 RVA: 0x001B86D8 File Offset: 0x001B68D8
			protected override X9ECParameters CreateParameters()
			{
				BigInteger bigInteger = new BigInteger("C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1", 16);
				BigInteger bigInteger2 = new BigInteger("01", 16);
		...
		{
			// Token: 0x06004F68 RID: 20328 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP224r1Holder()
			{
			}

			// Token: 0x06004F69 RID: 20329 RVA: 0x001B8754 File Offset: 0x001B6954
			protected override X9ECParameters CreateParameters()
			{
		...
		{
			// Token: 0x06004F6B RID: 20331 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP224t1Holder()
			{
			}

			// Token: 0x06004F6C RID: 20332 RVA: 0x001B87D0 File Offset: 0x001B69D0
			protected override X9ECParameters CreateParameters()
			{
				BigInteger bigInteger = new BigInteger("D7C134AA264366862A18302575D0FB98D116BC4B6DDEBCA3A5A7939F", 16);
				BigInteger bigInteger2 = new BigInteger("01", 16);
		...
		{
			// Token: 0x06004F6E RID: 20334 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP256r1Holder()
			{
			}

			// Token: 0x06004F6F RID: 20335 RVA: 0x001B884C File Offset: 0x001B6A4C
			protected override X9ECParameters CreateParameters()
			{
		...
		{
			// Token: 0x06004F71 RID: 20337 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP256t1Holder()
			{
			}

			// Token: 0x06004F72 RID: 20338 RVA: 0x001B88C8 File Offset: 0x001B6AC8
			protected override X9ECParameters CreateParameters()
			{
				BigInteger bigInteger = new BigInteger("A9FB57DBA1EEA9BC3E660A909D838D718C397AA3B561A6F7901E0E82974856A7", 16);
				BigInteger bigInteger2 = new BigInteger("01", 16);
		...
		{
			// Token: 0x06004F74 RID: 20340 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP320r1Holder()
			{
			}

			// Token: 0x06004F75 RID: 20341 RVA: 0x001B8944 File Offset: 0x001B6B44
			protected override X9ECParameters CreateParameters()
			{
		...
		{
			// Token: 0x06004F77 RID: 20343 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP320t1Holder()
			{
			}

			// Token: 0x06004F78 RID: 20344 RVA: 0x001B89C0 File Offset: 0x001B6BC0
			protected override X9ECParameters CreateParameters()
			{
				BigInteger bigInteger = new BigInteger("D35E472036BC4FB7E13C785ED201E065F98FCFA5B68F12A32D482EC7EE8658E98691555B44C59311", 16);
				BigInteger bigInteger2 = new BigInteger("01", 16);
		...
		{
			// Token: 0x06004F7A RID: 20346 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP384r1Holder()
			{
			}

			// Token: 0x06004F7B RID: 20347 RVA: 0x001B8A3C File Offset: 0x001B6C3C
			protected override X9ECParameters CreateParameters()
			{
		...
		{
			// Token: 0x06004F7D RID: 20349 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP384t1Holder()
			{
			}

			// Token: 0x06004F7E RID: 20350 RVA: 0x001B8AB8 File Offset: 0x001B6CB8
			protected override X9ECParameters CreateParameters()
			{
				BigInteger bigInteger = new BigInteger("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B31F166E6CAC0425A7CF3AB6AF6B7FC3103B883202E9046565", 16);
				BigInteger bigInteger2 = new BigInteger("01", 16);
		...
		{
			// Token: 0x06004F80 RID: 20352 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP512r1Holder()
			{
			}

			// Token: 0x06004F81 RID: 20353 RVA: 0x001B8B34 File Offset: 0x001B6D34
			protected override X9ECParameters CreateParameters()
			{
		...
		{
			// Token: 0x06004F83 RID: 20355 RVA: 0x001B58C5 File Offset: 0x001B3AC5
			private BrainpoolP512t1Holder()
			{
			}

			// Token: 0x06004F84 RID: 20356 RVA: 0x001B8BB0 File Offset: 0x001B6DB0
			protected override X9ECParameters CreateParameters()
			{
				BigInteger bigInteger = new BigInteger("AADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA70330870553E5C414CA92619418661197FAC10471DB1D381085DDADDB58796829CA90069", 16);
				BigInteger bigInteger2 = new BigInteger("01", 16);
