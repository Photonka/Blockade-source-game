...
{
	// Token: 0x06000098 RID: 152 RVA: 0x000092C0 File Offset: 0x000074C0
	private void myGlobalInit()
	{
		this.Active = false;
	}

	// Token: 0x06000099 RID: 153 RVA: 0x000092C9 File Offset: 0x000074C9
	...
	// Token: 0x0600009B RID: 155 RVA: 0x00009408 File Offset: 0x00007608
	private void OnGUI()
	{
	...
	// Token: 0x0600009C RID: 156 RVA: 0x0000947C File Offset: 0x0000767C
	...
	// Token: 0x0600009D RID: 157 RVA: 0x00009550 File Offset: 0x00007750
	...
	// Token: 0x0600009E RID: 158 RVA: 0x0000968C File Offset: 0x0000788C
	...
	// Token: 0x0600009F RID: 159 RVA: 0x000096E8 File Offset: 0x000078E8
	public void DrawActiveItem()
	{
		...
		{
			GUIManager.DrawText2(new Rect(184f, 36f, 412f, 152f), Lang.GetLabel(197), 16, 4, Color.green);
			return;
		}
		...
		if (Shop.THIS.currItem.Type == 1)
		{
			...
			GUIManager.DrawText2(new Rect(184f, 36f, 412f, 152f), Lang.GetLabel(199), 10, 7, Color.yellow);
			return;
		}
		if (Shop.THIS.currItem.Type == 2)
		{
			...
			GUIManager.DrawText2(new Rect(184f, 36f, 412f, 152f), Lang.GetLabel(200), 10, 7, Color.yellow);
		}
	}

	// Token: 0x060000A0 RID: 160 RVA: 0x00009988 File Offset: 0x00007B88
	...
	// Token: 0x060000A1 RID: 161 RVA: 0x00009990 File Offset: 0x00007B90
	...
	// Token: 0x060000A2 RID: 162 RVA: 0x00009BA0 File Offset: 0x00007DA0
	...
	// Token: 0x060000A3 RID: 163 RVA: 0x00009E18 File Offset: 0x00008018
	...
	// Token: 0x060000A4 RID: 164 RVA: 0x0000A2F4 File Offset: 0x000084F4
	private bool DrawButtonUpgrade(Rect r, float mx, float my, int id, int money)
	{
		...
		if (r.Contains(new Vector2(mx, my)) && !flag)
		{
			...
			GUIManager.DrawText(new Rect(r.x + 12f, r.y + 10f, 20f, 64f), num3.ToString(), 16, 5, 8);
	...
	// Token: 0x060000A5 RID: 165 RVA: 0x0000A5F4 File Offset: 0x000087F4
	...
	// Token: 0x060000A6 RID: 166 RVA: 0x0000A611 File Offset: 0x00008811
	...
	// Token: 0x060000A7 RID: 167 RVA: 0x0000A620 File Offset: 0x00008820
	...
	// Token: 0x060000A8 RID: 168 RVA: 0x0000A6D4 File Offset: 0x000088D4
	...
	// Token: 0x060000A9 RID: 169 RVA: 0x0000A760 File Offset: 0x00008960
