...
{
	// Token: 0x06000277 RID: 631 RVA: 0x0003370C File Offset: 0x0003190C
	private void Start()
	{
	...
	// Token: 0x06000278 RID: 632 RVA: 0x00033AA7 File Offset: 0x00031CA7
	...
	// Token: 0x06000279 RID: 633 RVA: 0x00033AD4 File Offset: 0x00031CD4
	private void OnGUI()
	{
	...
	// Token: 0x0600027A RID: 634 RVA: 0x000343C0 File Offset: 0x000325C0
	private void DrawTankState(float rBy, float rTy)
	{
		Rect rect;
		rect..ctor((float)(Screen.width - 156), (float)(Screen.height - 156), 156f, 156f);
		rect.center = new Vector2((float)(Screen.width - 156 + 78), (float)(Screen.height - 156 + 78));
		float num = rBy;
		...
		GUIUtility.RotateAroundPivot(-num, rect.center);
		GUIUtility.RotateAroundPivot(num2, rect.center);
		GUI.DrawTexture(rect, this.TurretPosition);
		GUIUtility.RotateAroundPivot(-num2, rect.center);
	}

	// Token: 0x0600027B RID: 635 RVA: 0x000344C8 File Offset: 0x000326C8
	...
	// Token: 0x0600027C RID: 636 RVA: 0x000345B1 File Offset: 0x000327B1
	...
	// Token: 0x0600027D RID: 637 RVA: 0x000345C0 File Offset: 0x000327C0
	private void Update()
	{
		...
		int num = 1049601;
		Vector3 point;
		if (Physics.Raycast(this.ray, ref this.hit, 1000f, num))
		{
		...
		quaternion.eulerAngles = Quaternion.Euler(0f, quaternion.eulerAngles.y - base.transform.rotation.eulerAngles.y, 0f).eulerAngles;
		this.Turret.transform.localRotation = Quaternion.RotateTowards(this.Turret.transform.localRotation, quaternion, 40f / ((float)this.currTank.turretRotation / 100f) * Time.deltaTime);
	...
	// Token: 0x0600027E RID: 638 RVA: 0x0003551C File Offset: 0x0003371C
	...
	// Token: 0x0600027F RID: 639 RVA: 0x00035734 File Offset: 0x00033934
	private void tryRayCast()
	{
		int num = 1025;
		int num2 = 1049601;
		this.L1_Down = Physics.Raycast(this.L1.position, Vector3.down, ref this.L1_hit_Down, 10f, num);
		this.L2_Down = Physics.Raycast(this.L2.position, Vector3.down, ref this.L2_hit_Down, 10f, num);
		this.L3_Down = Physics.Raycast(this.L3.position, Vector3.down, ref this.L3_hit_Down, 10f, num);
		this.L4_Down = Physics.Raycast(this.L4.position, Vector3.down, ref this.L4_hit_Down, 10f, num);
		...
		this.R2_Down = Physics.Raycast(this.R2.position, Vector3.down, ref this.R2_hit_Down, 10f, num);
		this.R3_Down = Physics.Raycast(this.R3.position, Vector3.down, ref this.R3_hit_Down, 10f, num);
		this.R4_Down = Physics.Raycast(this.R4.position, Vector3.down, ref this.R4_hit_Down, 10f, num);
	...
	// Token: 0x06000280 RID: 640 RVA: 0x00035ACC File Offset: 0x00033CCC
	...
	// Token: 0x06000281 RID: 641 RVA: 0x00036C04 File Offset: 0x00034E04
	...
	// Token: 0x06000282 RID: 642 RVA: 0x00037004 File Offset: 0x00035204
	...
	// Token: 0x06000283 RID: 643 RVA: 0x00037132 File Offset: 0x00035332
	private float getYF()
	{
		return (this.L1_hit_Down.point.y + this.R1_hit_Down.point.y + this.CF_hit_Down.point.y) / 3f;
	}

	// Token: 0x06000284 RID: 644 RVA: 0x0003716C File Offset: 0x0003536C
	private float getYB()
	{
		return (this.L5_hit_Down.point.y + this.R5_hit_Down.point.y + this.CB_hit_Down.point.y) / 3f;
	}

	// Token: 0x06000285 RID: 645 RVA: 0x000371A8 File Offset: 0x000353A8
	private float getYL()
	{
	...
	// Token: 0x06000286 RID: 646 RVA: 0x00037210 File Offset: 0x00035410
	private float getYR()
	{
	...
	// Token: 0x06000287 RID: 647 RVA: 0x00037278 File Offset: 0x00035478
	...
	// Token: 0x06000288 RID: 648 RVA: 0x0003756C File Offset: 0x0003576C
	private void Fire()
	{
	...
	// Token: 0x06000289 RID: 649 RVA: 0x000375D4 File Offset: 0x000357D4
	...
	// Token: 0x0600028A RID: 650 RVA: 0x00037650 File Offset: 0x00035850
	...
	// Token: 0x0600028B RID: 651 RVA: 0x00037B8C File Offset: 0x00035D8C
	...
	// Token: 0x0600028C RID: 652 RVA: 0x00037C7C File Offset: 0x00035E7C
	private void weapon_raycast(int wid, float dist, int blockdist)
	{
		...
		if (!Physics.Raycast(this.Gun.position, this.Gun.TransformDirection(Vector3.forward), ref raycastHit))
		{
			this.cl.send_milkattack(wid, Time.time);
			return;
		}
		RaycastHit raycastHit2;
		if (Physics.Linecast(raycastHit.point, this.Gun.position, ref raycastHit2, this.layerMask))
		{
			this.cl.send_milkattack(wid, Time.time);
			return;
		}
	...
	// Token: 0x0600028D RID: 653 RVA: 0x00037F68 File Offset: 0x00036168
	private Vector3i? GetCursor(bool inside, int radius)
	{
		Ray ray;
		ray..ctor(this.Gun.position, this.Gun.TransformDirection(Vector3.forward));
